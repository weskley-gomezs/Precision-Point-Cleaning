      ...
      {slides.map((slide, index) => (
        ...
        >
          ...
          <div className="absolute inset-0 flex flex-col justify-center items-center text-center px-4 z-10">
            ...
            <button className="border-2 border-white text-white px-5 py-2 md:px-8 md:py-3 rounded-full font-bold uppercase text-xs sm:text-sm md:text-base hover:bg-white hover:text-brand-red transition-all duration-300 tracking-wider">
              {slide.buttonText}
            </button>
          </div>
        </div>
